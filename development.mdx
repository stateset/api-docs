...
Each CLI is linked to a specific version of Stateset. Please update the CLI if your local website looks different than production.

<CodeGroup>

```bash npm
npm i -g stateset@latest
```

```bash yarn
yarn global upgrade stateset
```
