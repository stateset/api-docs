...
1) Setup your company's Stateset One instance by signing up at <a href="stateset.io/signup">stateset.io/signup</a>

2) Create a new API Key in the Stateset Cloud Console <a href="cloud.stateset.com/api-keys">cloud.stateset.com/api-keys</a>
