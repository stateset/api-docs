...
1) Setup your company's Stateset One instance by signing up at <a href="stateset.io/signup" target="_blank">stateset.io/signup</a>

2) Create a new API Key in the Stateset Cloud Console <a href="cloud.stateset.com/api-keys" target="_blank">cloud.stateset.com/api-keys</a>
...
![Return Record](/images/returns/return-record.png)
