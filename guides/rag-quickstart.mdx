...
description: "Getting started with RAG ("Retrieval-Augmented Generation")"
---
...
RAG is composed of several components that work together to provide a powerful system for generating responses to queries. The following diagram illustrates the architecture of RAG:
