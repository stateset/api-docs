---
title: "Update Vendor"
api: "PUT https://api.stateset.com/api/vendor"
description: "This endpoint updates an existing vendor."
---
...
curl --location --request PUT 'https://api.stateset.com/api/vendor' \
