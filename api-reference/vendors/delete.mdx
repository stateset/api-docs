---
title: "Delete Vendor"
api: "DELETE https://api.return.com/api/vendor"
description: "This endpoint deletes an existing vendor."
---
...
```bash cURL
curl --location --request DELETE 'https://api.stateset.com/api/vendor' \
