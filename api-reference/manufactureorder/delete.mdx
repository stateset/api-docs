...
api: "DELETE https://api.stateset.com/api/manufacture_order"
description: "This endpoint deletes an existing manufacture order."
---
...
curl --location --request DELETE 'https://api.stateset.com/api/manufacture_order' \
