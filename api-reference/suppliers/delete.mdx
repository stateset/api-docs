...
api: "DELETE https://api.return.com/api/supplier"
description: "This endpoint deletes an existing supplier."
---
...
```bash cURL
curl --location --request DELETE 'https://api.stateset.com/api/supplier' \
