...
api: "PUT https://api.stateset.com/api/supplier"
description: "This endpoint updates an existing supplier."
---
...
```bash cURL
curl --location --request PUT 'https://api.stateset.com/api/supplier' \
