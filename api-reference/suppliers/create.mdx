...
api: "POST https://api.stateset.com/api/supplier"
description: "This endpoint creates a new supplier"
---
...
curl --location --request POST 'https://api.stateset.com/api/supplier' \
