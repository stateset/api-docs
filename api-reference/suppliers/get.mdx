---
title: "Get Supplier"
api: "GET https://api.stateset.com/api/supplier"
description: "This endpoint gets or creates a new supplier."
---
...
```bash cURL
curl --location --request GET 'https://api.stateset.com/api/supplier' \
