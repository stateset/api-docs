...
api: "GET https://api.stateset.com/api/customer/list"
description: "This endpoint list customers."
---
...
var customer = await stateset.customers.list({
  'sso_id': '1234-5678-9012-3456'
});
...
customer = stateset.customers.list({
  'sso_id': '1234-5678-9012-3456'
})
