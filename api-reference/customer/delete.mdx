...
https://api-docs.stateset.io/api-reference

We are working on building our client libaries in the following languages:
...
We are excited about the release of the new REST API and we are looking forward to seeing what you build with it!