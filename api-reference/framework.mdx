---
title: "Framework"
description: "Building server rendered applications with React Server Components (RSC) framework"
---
...
React Server Components (RSC) is a new way to build server-rendered applications with React. It is a set of experimental tools that enables developers to run React components on the server. RSC is a new way to build server-rendered applications with React. It is a set of experimental tools that enables developers to run React components on the server.
...
export const getReturnAction = async (returnId: string): Promise<Return | undefined> => {
