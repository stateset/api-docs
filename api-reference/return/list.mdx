---
title: "List Returns"
api: "GET https://api.stateset.com/v1/returns"
...
```bash cURL
curl --location --request GET 'https://api.stateset.com/v1/returns' \
...
```graphQL GraphQL
query ($limit: Int!, $offset: Int!, $order_direction: order_by, $status: String!) {
