...
api: "GET https://api.stateset.com/api/return/retrieve"
description: "This endpoint retrieves a return."
---
...
```bash cURL
curl --location --request GET 'https://api.stateset.com/api/return/retrieve' \
