---
title: "Update Manufacture Order Line Item"
api: "PUT https://api.stateset.com/api/manufacture_order_line_item"
description: "This endpoint updates an existing manufacture order line item."
---
...
```bash cURL
curl --location --request PUT 'https://api.stateset.com/api/manufacture_order_line_item' \
