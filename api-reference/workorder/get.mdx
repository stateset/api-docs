...
<ResponseField body="created_at" type="string">
  Date and time when the work order was created
</ResponseField>

<ResponseField body="created_by" type="string">
  Name or identifier of the person who created the work order
</ResponseField>

<ResponseField body="expected_completion_date" type="string">
...
<ResponseField body="issue_date" type="string">
...
<ResponseField body="manufacture_order" type="string">
  Identifier or reference to the manufacturing order associated with the work order
</ResponseField>

<ResponseField body="memo" type="string">
...
<ResponseField body="order_number" type="string">
  Identifier or reference to the order associated with the work order
</ResponseField>

<ResponseField body="part" type="string">
  Part or item associated with the work order
</ResponseField>

<ResponseField body="priority" type="string">
...
<ResponseField body="updated_at" type="string">
  Date and time when the work order was last updated
</ResponseField>

<ResponseField body="work_order_line_items" type="string">
  ...
  <ResponseField body="line_status" type="string">
  ...
  <ResponseField body="total_quantity" type="string">
    Total quantity of the part or item required or used in the work order
  </ResponseField>

  <ResponseField body="unit_quantity" type="string">
