...
api: "POST https://api.stateset.com/api/purchaseorder/:id/cancel"
...
```bash cURL
curl --location --request POST 'https://api.stateset.com/api/purchase_order/:id/cancel' \
...
```http HTTP
POST /api/purchaseorder/:id/cancel HTTP/1.1
