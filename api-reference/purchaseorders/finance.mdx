...
api: "POST https://api.stateset.com/api/purchaseorder/:id/finance"
...
```bash cURL
curl --location --request POST 'https://api.stateset.com/api/purchase_order/:id/finance' \
...
```http HTTP
POST /api/purchaseorder/:id/finance HTTP/1.1
