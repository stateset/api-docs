...
api: "GET https://api.stateset.com/api/purchase_order/list"
description: "This lists purchase orders."
---
...
```bash cURL
curl --location --request GET 'https://api.stateset.com/api/purchase_order/list' \
